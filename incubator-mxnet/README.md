...
Please install this modified MXNet by following the instructions below:

  1. Fetch the public version of MXNet ```git clone https://github.com/apache/incubator-mxnet.git --recursive -b v1.7.x```
  2. Replace the folders above by the ones in this repository
